 ...
 * {@link Edit_Profilr_Ngo.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Edit_Profilr_Ngo#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Edit_Profilr_Ngo extends Fragment {
    ...
    public static Edit_Profilr_Ngo newInstance(String param1, String param2) {
        Edit_Profilr_Ngo fragment = new Edit_Profilr_Ngo();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_edit_profilr_ngo, container, false);
        final Toolbar toolbar = (Toolbar) v.findViewById(R.id.tab_edit_profile_ngo);
        ((AppCompatActivity) getActivity()).setSupportActionBar(toolbar);
        toolbar.setTitleTextColor(getResources().getColor(R.color.colorPrimary));
        toolbar.setTitle("Edit Profile");
        contact=(EditText)v.findViewById(R.id.edit_contact_ngo);
        address=(EditText)v.findViewById(R.id.edit_address_ngo);
        email=(EditText)v.findViewById(R.id.edit_email_ngo);
        info=(EditText)v.findViewById(R.id.edit_info_ngo);
        Button update=(Button)v.findViewById(R.id.update_ngo);
    ...
    public void updateProfile(){
        ...
        String REGISTER_URL="http://vipul.hol.es/editProfileNgo.php";
