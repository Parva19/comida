...
import gbpec.comida.donor_module.HistoryAdapter;
import gbpec.comida.donor_module.HistoryFields;
import gbpec.comida.donor_module.History_Module;


public class History_Module_NGO extends Fragment {
...
//                        Toast.makeText(getActivity().getApplicationContext(),error.getMessage().toString(),Toast.LENGTH_LONG).show();
    ...
    public void prepareMovieData(JSONObject business) throws JSONException {
        ...
        reciever=business.getString("donor");
